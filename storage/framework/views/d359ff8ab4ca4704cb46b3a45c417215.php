...
<?php $__env->startSection('title', 'Daftar Peserta - ' . $stasi->nama); ?>
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">
                        ...
                        Waktu: <?php echo e($jadwal->mulai->format('d F Y H:i')); ?> - <?php echo e($jadwal->selesai->format('H:i')); ?>

                    </p>
                </div>
                <a href="<?php echo e(route('penguji.penilaian.stasi', $stasi)); ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300">
                    ← Kembali
                </a>
            </div>
        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-sm text-gray-500"><?php echo e($sudahDinilai); ?> / <?php echo e($peserta->count()); ?></span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-indigo-600 h-2.5 rounded-full" style="width: <?php echo e($peserta->count() > 0 ? ($sudahDinilai / $peserta->count() * 100) : 0); ?>%"></div>
            </div>
        </div>
    </div>
    <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                    <?php if($canNilai): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <?php if($adaNilaiDariPengujiLain): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                    <?php if($canNilai): ?>
                                        <a href="<?php echo e(route('penguji.penilaian.form', ['stasi' => $stasi, 'jadwal' => $jadwal, 'mahasiswa' => $mhs])); ?>" 
                                           class="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md <?php echo e($sudahNilai ? 'text-indigo-700 bg-indigo-100 hover:bg-indigo-200' : 'text-white bg-indigo-600 hover:bg-indigo-700'); ?>">
                                            <?php echo e($sudahNilai ? 'Edit Nilai' : 'Nilai'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Aplikasi Ujian\resources\views/penguji/penilaian/list.blade.php ENDPATH**/ ?>