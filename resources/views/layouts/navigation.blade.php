            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.penguji.index')" :active="request()->routeIs('admin.penguji.*')">
                            Penguji
                        </x-nav-link>
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('penguji.stasi.index')" :active="request()->routeIs('penguji.stasi.*') || request()->routeIs('penguji.penilaian.*')">
                            Penilaian
                        </x-nav-link>
                    @endif
                </div>
