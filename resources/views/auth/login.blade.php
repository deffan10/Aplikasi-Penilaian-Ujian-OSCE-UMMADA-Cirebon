...
<form method="POST" action="{{ route('login') }}">
    ...
    <div>
        ...
        <x-text-input id="login" class="block mt-1 w-full" type="text" name="login" :value="old('login')" required autofocus autocomplete="username" placeholder="Masukkan username atau email" />
    ...
    <div class="flex flex-col sm:flex-row items-center justify-end mt-4 gap-3 sm:gap-0">
        ...
        <x-primary-button class="mt-3 sm:mt-0 sm:ms-3 w-full sm:w-auto justify-center">
            {{ __('Log in') }}
        </x-primary-button>
    </div>
</form>
